...
const Sidebar = ({ selectedArtist, setSelectedArtist, onClearSession, chatHistory, onClearHistory, onClose, onLoadSession }) => {
            ...
            {chatHistory.length === 0 ? (
              ...
              chatHistory.map((item) => (
                <div
                  ...
                  className="w-full bg-white/5 border border-white/5 p-3 md:p-4 rounded-2xl flex items-center gap-4 cursor-pointer hover:bg-[#CDD400]/10 transition-all group"
                >
